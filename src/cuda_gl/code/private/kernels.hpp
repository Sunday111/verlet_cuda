...
public:
    ...
    static void SolveCollisions_OneRow(cudaStream_t& stream, GridCell* cells, Vec2f* positions, size_t cell_y, size_t offset_x);
    static void SolveCollisions_ManyRows(cudaStream_t& stream, GridCell* cells, Vec2f* positions, edt::Vec2<size_t> offset);
